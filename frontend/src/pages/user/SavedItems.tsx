...
import { CaretRight, ListDashes, MagnifyingGlass, SquaresFour } from '@phosphor-icons/react';
    ...
    <section className={`app-container w-full mt-[12px] s-1025:px-[80px] s-767:px-[40px] px-[16px] `}>
      <div className='w-full'>
        <div className='s-480:pt-[30px] pt-[18px] pb-[18px] flex items-center space-x-2'>
          <span className='flex items-center space-x-2' style={{ color: '#a6a4a4' }}><Link to={'/user/accounts'}>Accounts</Link> <CaretRight size={14} /> </span> <span className='font-medium'>Saved Items</span>
        </div>

        <div className='flex items-start space-x-3 w-full'>
          <AccountSidebar />

          <div className='border border-gray-200 rounded-[5px] s-480:pt-[16px] pt-[8px] s-480:pb-[40px] pb-[0]'>
            <h1 className='s-480:text-[18px] text-[16px] font-medium border-b border-gray-200 px-[14px] s-480:pb-[12px] pb-[6px] s-480:mb-[18px] mb-[9px]'>Saved Items</h1>
            <div className='s-480:px-[14px] px-[4px]'>
