...
const ProductFrame = ({ product, key, isFlexDisplay, price_font_size, discount_font_size, shop_button, icon_size, details_adjust, showControls, product_image='product-image' }: Props) => {
                ...
                <div className='flex mb-[16px] border s-767:p-3 rounded-[5px] '>
                    <Link to={`/products/product-details/${product._id}`}>
                        <div className='relative s-767:max-w-[400px] max-w-[300px] w-full s-767:p-0 p-[5px]'>
                            <img className='rounded-[5px]  product-image-3' src={product?.image} alt={'enchanté_fashon'} />
                    ...
                    <div className='w-full relative s-767:p-[16px] p-[0] s-767:py-0 py-1'>
                        <div className="details s-767:flex block item-center justify-between s-767:px-0 px-2">
                            <div className='max-w-[400px]'>
                                ...
                                <h3 className='s-767:text-[16px] text-[12px] s-767:pb-0 pb-2'>{width > 767 ? characterLimit(product?.desc, 70) : characterLimit(product?.desc, 30)}...</h3>
                            </div>
                    ...
                    <div>
                        <Link onClick={() => addToRecentlyViewedAction(product)} to={`/products/product-details/${product._id}`}>
                            <div className='relative'>
                                <img className={`rounded-[5px] ${product_image} border border-gray-200`} src={product?.image} alt={'enchanté_fashon'} />
