...
import { getAllProducts, sortByHighestPrice, sortByLowestPrice, sortByNameAZ, sortByNameZA } from "../reducers/products/productsSlice";
...
const Products = () => {
    ...
    const { filteredProducts, filterTerms, isLoading, isError, isSuccess , message} = useAppSelector((state: RootState) => state.products);
