                    ...
                    <div className="text-card-container">
                        {heroDisplayTexts.map((val, index) => (
                            <div className={`text-card ${determineClasses(index)}`} key={val.tag}>
                                <h1 className={`s-767:text-[42px] s-480:text-[32px] s-400:text-[24px] text-[21px] font-nunitosans font-bold leading-tight s-767:pb-[30px] pb-[10px] s-767:text-left text-center`}>
                                    {val.title}
                                </h1>
