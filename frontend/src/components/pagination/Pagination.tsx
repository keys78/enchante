    ...
    return (
        <div className="flex items-center s-767:space-x-5 space-x-1 justify-center mx-[16px]">
            <motion.button
                ...
                className="text-[14px] capitalize font-medium flex items-center justify-center space-x-2 pagination-controls border-none outline-none border border-black  s-480:py-2 py-1 s-400:px-3 px-2 s-400:w-[100px] w-[70px] text-white bg-black"
