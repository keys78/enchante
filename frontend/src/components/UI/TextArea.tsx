...
const TextArea: React.FC<textAreaProps> = ({ label, ...props }) => {
  ...
  return (
    <div className="mb-3 mt-4">
      ...
      <textarea
        className={` body-lg w-full sm:h-28 h-20 sm:text-[16px] text-[14px] px-4 py-2 block rounded resize-none border border-mediumGrey border-opacity-25 placeholder:opacity-50
